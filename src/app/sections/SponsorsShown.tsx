...
const SponsorTemplate = () => (
  <div className="bg-orange-200 p-1 rounded-lg">
    <div className=" w-full h-28 md:h-32 rounded-lg border-3 border-dashed border-orange-400/50  flex items-center justify-center">
      <span className="text-black text-shadow-md text-shadow-white text-bold text-center transform -rotate-45">
        Anúncie
        <br />
        Aqui
      </span>
...
const sponsors: (Sponsor | null)[] = [
  {
    name: "Grupo Ideal",
    logoUrl: "/logo-ideal.png",
    websiteUrl: "https://idealgrupo.com.br",
  },
  null,
  null,
  null,
...
export default function SponsorsGrid({
  ...
  return (
    ...
    >
      <h2
        className="text-3xl lg:text-4xl font-bold text-center mb-6 text-orange-600"
        data-aos="fade-down"
      >
        Patrocinadores
      </h2>
      ...
      <div
        className="grid grid-cols-3 gap-6 w-full lg:w-3/5 max-w-7xl"
        data-aos="fade-up"
      >
